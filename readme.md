...
<p>For logging to work, modify the Access Logging directory permissions to include the group allowed to authenticate to the site.  The included powershell script can be run on a scheduled task as often as you'd like to archive the access log and keep it's size small enough to not impact performance.</p>


<h2>Original Base Project</h2>
